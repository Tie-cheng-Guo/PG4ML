...
create or replace function sm_sc.fv_atrim
(
  i_array               anyarray,
...
parallel safe
cost 100;
-- select sm_sc.fv_atrim(array[[0,0,0,0,0,2], [0,0,1,2,0,4], [0,1,0,2,0,0], [0,0,0,0,1,2], [1,0,1,0,0,3]], 0)
-- select sm_sc.fv_atrim(array[0,1,2,3,4,5], 0)