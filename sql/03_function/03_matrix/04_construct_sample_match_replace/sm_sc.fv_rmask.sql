...
create or replace function sm_sc.fv_rmask
(
  i_array               anyarray    ,
    ...
    (
      select 
        ...
        (
          ...
          , nullif(int4range(v_background_width - i_mask_len[a_cur_y][1] + 1, v_background_width + 1, '[)'), 'empty' :: int4range)
          ]
        )
    ...
    (
      select 
        ...
        (
          ...
          , nullif(int4range(v_background_width - i_mask_len[a_cur_y][a_cur_x][1] + 1, v_background_width + 1, '[)'), 'empty' :: int4range)
          ]
        )
      from generate_series(1, array_length(i_mask_len, 1)) tb_a_cur_y(a_cur_y)
    ...
    (
      select 
        ...
        (
          ...
          , nullif(int4range(v_background_width - i_mask_len[a_cur_y][a_cur_x][a_cur_x3][1] + 1, v_background_width + 1, '[)'), 'empty' :: int4range)
          ]
        )
      from generate_series(1, array_length(i_mask_len, 1)) tb_a_cur_y(a_cur_y)
        , generate_series(1, array_length(i_mask_len, 2)) tb_a_cur_x(a_cur_x)
