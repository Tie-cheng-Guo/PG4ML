...
create or replace function sm_sc.ft_rand_slice_x3
(
  i_array          anyarray          ,
  i_select_cnt     int
)
...
begin
  ...
  -- --     from unnest(sm_sc.fv_rand_1d_ele(array_length(i_array, 3), i_select_cnt)) tb_a_cur(a_cur)
  -- --   ;
...
cost 100;
-- -- set search_path to sm_sc;
-- -- select * from sm_sc.ft_rand_slice_x3
-- --   (
