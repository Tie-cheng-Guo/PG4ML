      ...
      loop
        ...
        loop
          ...
          (
            ...
            from regexp_matches(i_array[v_y_cur][v_x_cur][v_x3_cur], i_pattern[v_y_cur][v_x_cur][v_x3_cur], i_flags) tb_a(a_matches)
          );
        end loop;    
      end loop;
    end loop;
      ...
      loop
        ...
        loop
          ...
          loop
            ...
            (
              select array_agg(a_matches)::text 
              from regexp_matches(i_array[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur], i_pattern[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur], i_flags) tb_a(a_matches)
            );
          end loop;
        end loop;    
      end loop;
    ...
    loop
      ...
      loop
        ...
        loop
          ...
          (
            select array_agg(a_matches)::text 
            from regexp_matches(i_array[v_y_cur][v_x_cur][v_x3_cur], i_pattern, i_flags) tb_a(a_matches)
          );
        end loop;    
      end loop;
    end loop;
      ...
      loop
        ...
        loop
          ...
          loop
            ...
            (
              select array_agg(a_matches)::text 
              from regexp_matches(i_array[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur], i_pattern, i_flags) tb_a(a_matches)
            );
          end loop;
        end loop;    
      end loop;
    ...
    loop
      ...
      loop
        ...
        loop
          ...
          (
            select array_agg(a_matches)::text 
            from regexp_matches(i_array, i_pattern[v_y_cur][v_x_cur][v_x3_cur], i_flags) tb_a(a_matches)
          );
        end loop;    
      end loop;
    end loop;
      ...
      loop
        ...
        loop
          ...
          loop
            ...
            (
              select array_agg(a_matches)::text 
              from regexp_matches(i_array, i_pattern[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur], i_flags) tb_a(a_matches)
            );
          end loop;
        end loop;    
      end loop;
