...
create or replace function sm_sc.fv_d_mx_slice_3d_2_2d_dloss_dindepdt
(
  i_dloss_dindepdt  float[]  
, i_indepdt_len     int[3]                  -- 自变量规格
...
begin
  ...
  then 
    ...
    elsif array[array_length(i_dloss_dindepdt, 1), array_length(i_dloss_dindepdt, 2)] <> (i_indepdt_len[ : i_dim_sliced - 1] || i_indepdt_len[i_dim_sliced + 1 : ])
    then 
