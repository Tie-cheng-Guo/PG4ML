...
create or replace function sm_sc.fv_d_bmask_dloss_dindepdt_1
(
...
-- declare 
begin
  return sm_sc.fv_bmask(i_dloss_ddepdt, i_co_value, 0.0 :: float);
...
-- select 
--   sm_sc.fv_d_bmask_dloss_dindepdt_1
--   (
--     array
--     [
--       [1, 2, 3, 4, 5]
