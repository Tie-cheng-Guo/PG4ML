...
create or replace function sm_sc.fv_d_rpad_dloss_dindepdt_2
(
...
begin
  ...
  then
    ...
    (
      select 
        sm_sc.fa_mx_sum(i_dloss_ddepdt[ : ][v_len - (a_cur * i_indepdt_width) + 1 : v_len - ((a_cur - 1) * i_indepdt_width)])
...
-- -- set search_path to sm_sc;
-- select sm_sc.fv_d_rpad_dloss_dindepdt_2
--   (
--     array[1, 2, 3, 4, 5, 6],
--     array[7, 8],
--     2
