  ...
  then
    ...
    loop
      ...
      loop
        ...
        loop
          i_left[v_y_cur][v_x_cur][v_x3_cur] = coalesce(i_left[v_y_cur][v_x_cur][v_x3_cur], i_right[v_y_cur][v_x_cur][v_x3_cur]);
        end loop;    
      end loop;
    end loop;
    return i_left;
    ...
    loop
      ...
      loop
        ...
        loop
          ...
          loop
            i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = coalesce(i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur], i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur]);
          end loop;
        end loop;    
      end loop;
    end loop;
...
-- select sm_sc.fv_coalesce(array[1], array[array[1,2,3]]);
-- select sm_sc.fv_coalesce(array[array[1]], array[1,2,3]);
-- select sm_sc.fv_coalesce(array[array[1]], array[array[1,2,3]]);
  ...
  then
    ...
    loop
      ...
      loop
        ...
        loop
          i_left[v_y_cur][v_x_cur][v_x3_cur] = coalesce(i_left[v_y_cur][v_x_cur][v_x3_cur], i_right);
        end loop;    
      end loop;
    end loop;
    return i_left;
    ...
    loop
      ...
      loop
        ...
        loop
          ...
          loop
            i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = coalesce(i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur], i_right);
          end loop;
        end loop;    
      end loop;
    end loop;
...
parallel safe
cost 100;
-- select sm_sc.fv_coalesce(array[array[12.3, 25.1], array[2.56, 3.25]], 8.8)
-- select sm_sc.fv_coalesce(array[]::float[], 8.8)
-- select sm_sc.fv_coalesce(array[]::float[], null)
-- select sm_sc.fv_coalesce(array[1.2, 2.3]::float[], 8.8)
-- select sm_sc.fv_coalesce(array[array[], array []]::float[], 8.8)
-- select sm_sc.fv_coalesce(array[1.2, 2.3]::float[], null::float)
-- select 
--   sm_sc.fv_coalesce
--   (
--     array[[[1,2,3],[1.2,2.3,3.4]],[[0.5,0.7,0.8],[0.3,0.4,0.7]]]
  ...
  then
    ...
    loop
      ...
      loop
        ...
        loop
          i_right[v_y_cur][v_x_cur][v_x3_cur] = coalesce(i_left, i_right[v_y_cur][v_x_cur][v_x3_cur]);
        end loop;    
      end loop;
    end loop;
    return i_right;
    ...
    loop
      ...
      loop
        ...
        loop
          ...
          loop
            i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = coalesce(i_left, i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur]);
          end loop;
        end loop;    
      end loop;
    end loop;
