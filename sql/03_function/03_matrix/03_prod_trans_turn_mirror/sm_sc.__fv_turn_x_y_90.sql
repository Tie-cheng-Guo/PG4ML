...
create or replace function sm_sc.__fv_turn_x_y_90
(
  i_right     anyarray
)
returns anyarray
...
begin
  ...
  then
    ...
    loop 
      ...
      loop 
        v_ret[v_len_x - v_cur_1 + 1 : v_len_x - v_cur_1 + 1][v_cur_2 : v_cur_2][ : ] := i_right[v_cur_2 : v_cur_2][v_cur_1 : v_cur_1][ : ];
      end loop;
    end loop;
    return v_ret;
