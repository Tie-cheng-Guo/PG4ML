...
create or replace function sm_sc.fv_d_concat_x4_dloss_dindepdt
(
...
begin
  ...
  then
    if i_indepdt_len[4] <> upper(i_indepdt_idx_range) - lower(i_indepdt_idx_range)
    then 
...
-- -- set search_path to sm_sc;
-- -- select sm_sc.fv_d_concat_x4_dloss_dindepdt
-- --   (
