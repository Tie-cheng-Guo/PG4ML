...
-- drop function if exists sm_sc.fv_aggr_slice_stddev_samp_py(float[]);
create or replace function sm_sc.fv_aggr_slice_stddev_samp_py
(
  i_array          float[]
)
returns float
...
$$
  import numpy as np
  return np.nanstd(np.float32(i_array), ddof=1).tolist()
$$
language plpython3u stable
parallel safe
cost 100;
-- -- set search_path to sm_sc;
-- select sm_sc.fv_aggr_slice_stddev_samp_py
--   (
...
-- ------------------------------------------------------------------------------------------------------
-- drop function if exists sm_sc.fv_aggr_slice_stddev_samp_py(float[], int[]);
create or replace function sm_sc.fv_aggr_slice_stddev_samp_py
(
  i_array          float[],
  i_cnt_per_grp    int[]
...
cost 100;
-- select 
--   sm_sc.fv_aggr_slice_stddev_samp_py
--   (
...
-- )
-- select 
--   sm_sc.fv_aggr_slice_stddev_samp_py(a_arr, array[3,7]) :: decimal[] ~=` 3
-- = sm_sc.fv_aggr_slice_stddev_samp(a_arr, array[3,7]) :: decimal[] ~=` 3
-- from cte_arr
...
-- )
-- select 
--   sm_sc.fv_aggr_slice_stddev_samp_py(a_arr, array[3,7,4]) :: decimal[] ~=` 3
-- = sm_sc.fv_aggr_slice_stddev_samp(a_arr, array[3,7,4]) :: decimal[] ~=` 3
-- from cte_arr
...
-- )
-- select 
--   sm_sc.fv_aggr_slice_stddev_samp_py(a_arr, array[3,7,4,5]) :: decimal[] ~=` 3
-- = sm_sc.fv_aggr_slice_stddev_samp(a_arr, array[3,7,4,5]) :: decimal[] ~=` 3
-- from cte_arr