...
-- drop function if exists sm_sc.fv_aggr_slice_avg_py(float[]);
create or replace function sm_sc.fv_aggr_slice_avg_py
(
  i_array          float[]
)
returns float
...
$$
  import numpy as np
  return np.nanmean(np.float32(i_array)).tolist()
$$
language plpython3u stable
parallel safe
cost 100;
-- -- set search_path to sm_sc;
-- select sm_sc.fv_aggr_slice_avg_py
--   (
...
-- ------------------------------------------------------------------------------------------------------
-- drop function if exists sm_sc.fv_aggr_slice_avg_py(float[], int[]);
create or replace function sm_sc.fv_aggr_slice_avg_py
(
  i_array          float[],
  i_cnt_per_grp    int[]
...
$$
  ...
  v_cnt_per_grp = np.int32(i_cnt_per_grp)
...
-- )
-- select 
--   sm_sc.fv_aggr_slice_avg_py(a_arr, array[3,7])
-- = sm_sc.fv_aggr_slice_avg_py(a_arr, array[3,7])
-- from cte_arr
...
-- )
-- select 
--   sm_sc.fv_aggr_slice_avg_py(a_arr, array[3,7,4])
-- = sm_sc.fv_aggr_slice_avg_py(a_arr, array[3,7,4])
-- from cte_arr
...
-- )
-- select 
--   sm_sc.fv_aggr_slice_avg_py(a_arr, array[3,7,4,5])
-- = sm_sc.fv_aggr_slice_avg_py(a_arr, array[3,7,4,5])
-- from cte_arr