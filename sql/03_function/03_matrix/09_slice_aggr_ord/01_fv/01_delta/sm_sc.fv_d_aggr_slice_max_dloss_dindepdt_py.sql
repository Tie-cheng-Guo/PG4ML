-- drop function if exists sm_sc.fv_d_aggr_slice_max_dloss_dindepdt_py(float[], float[], float[]);
create or replace function sm_sc.fv_d_aggr_slice_max_dloss_dindepdt_py
(
  i_indepdt        float[]
, i_depdt          float[]
...
cost 100;
-- select 
--   sm_sc.fv_d_aggr_slice_max_dloss_dindepdt_py
