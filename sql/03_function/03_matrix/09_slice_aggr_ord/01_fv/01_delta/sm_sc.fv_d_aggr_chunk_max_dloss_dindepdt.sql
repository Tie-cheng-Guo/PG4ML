...
create or replace function sm_sc.fv_d_aggr_chunk_max_dloss_dindepdt
(
  i_indepdt        anyarray,
  i_depdt          anyarray,
...
--   (
--     a_indepdt
--   , sm_sc.fv_aggr_chunk_max(a_indepdt, array[3])
...
--   (
--     a_indepdt
--   , sm_sc.fv_aggr_chunk_max(a_indepdt, array[3, 2])
...
--   (
--     a_indepdt
--   , sm_sc.fv_aggr_chunk_max(a_indepdt, array[3, 2, 2, 3])
