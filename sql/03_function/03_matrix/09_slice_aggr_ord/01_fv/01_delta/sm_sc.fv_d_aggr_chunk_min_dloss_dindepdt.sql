...
create or replace function sm_sc.fv_d_aggr_chunk_min_dloss_dindepdt
(
  i_indepdt        anyarray,
  i_depdt          anyarray,
...
--   (
--     a_indepdt
--   , sm_sc.fv_aggr_chunk_min(a_indepdt, array[3])
--   , sm_sc.fv_new(1.0 :: float, array[3])
--   )
-- from cte_rand
...
--   (
--     a_indepdt
--   , sm_sc.fv_aggr_chunk_min(a_indepdt, array[3, 2])
--   , sm_sc.fv_new(1.0 :: float, array[3, 2])
--   )
-- from cte_rand
...
--   , sm_sc.fv_new(1.0 :: float, array[3, 2, 2])
--   )
-- from cte_rand
...
--   (
--     a_indepdt
--   , sm_sc.fv_aggr_chunk_min(a_indepdt, array[3, 2, 2, 3])
--   , sm_sc.fv_new(1.0 :: float, array[3, 2, 2, 3])
--   )
-- from cte_rand