...
-- drop function if exists sm_sc.fv_aggr_slice_sum_py(float[]);
create or replace function sm_sc.fv_aggr_slice_sum_py
(
  i_array          float[]
)
returns float
...
$$
  import numpy as np
  return np.nansum(np.float32(i_array)).tolist()
$$
...
-- ---------------------------------------------------
-- drop function if exists sm_sc.fv_aggr_slice_sum_py(bigint[]);
create or replace function sm_sc.fv_aggr_slice_sum_py
(
  i_array          bigint[]
)
...
$$
  import numpy as np
  return np.nansum(np.int64(i_array)).tolist()
$$
language plpython3u stable
parallel safe
cost 100;
...
-- ---------------------------------------------------
-- drop function if exists sm_sc.fv_aggr_slice_sum_py(int[]);
create or replace function sm_sc.fv_aggr_slice_sum_py
(
  i_array          int[]
)
...
$$
  import numpy as np
  return np.nansum(np.int32(i_array)).tolist()
$$
language plpython3u stable
parallel safe
cost 100;
...
-- -- set search_path to sm_sc;
-- select sm_sc.fv_aggr_slice_sum_py
--   (
...
-- ------------------------------------------------------------------------------------------------------
-- drop function if exists sm_sc.fv_aggr_slice_sum_py(float[], int[]);
create or replace function sm_sc.fv_aggr_slice_sum_py
(
  i_array          float[],
  i_cnt_per_grp    int[]
...
-- )
-- select 
--   sm_sc.fv_aggr_slice_sum_py(a_arr, array[3,7]) :: decimal[] ~=` 4
-- = sm_sc.fv_aggr_slice_sum_py(a_arr, array[3,7]) :: decimal[] ~=` 4
-- from cte_arr
...
-- )
-- select 
--   sm_sc.fv_aggr_slice_sum_py(a_arr, array[3,7,4]) :: decimal[] ~=` 2
-- = sm_sc.fv_aggr_slice_sum_py(a_arr, array[3,7,4]) :: decimal[] ~=` 2
-- from cte_arr
...
-- )
-- select 
--   sm_sc.fv_aggr_slice_sum_py(a_arr, array[3,7,4,5]) :: decimal[] ~=` 2
-- = sm_sc.fv_aggr_slice_sum_py(a_arr, array[3,7,4,5]) :: decimal[] ~=` 2
-- from cte_arr

-- ------------------------------------------------------------------------------------------------------
-- drop function if exists sm_sc.fv_aggr_slice_sum_py(bigint[], int[]);
create or replace function sm_sc.fv_aggr_slice_sum_py
(
  i_array          bigint[],
  i_cnt_per_grp    int[]
...
-- ------------------------------------------------------------------------------------------------------
-- drop function if exists sm_sc.fv_aggr_slice_sum_py(int[], int[]);
create or replace function sm_sc.fv_aggr_slice_sum_py
(
  i_array          int[],
  i_cnt_per_grp    int[]
