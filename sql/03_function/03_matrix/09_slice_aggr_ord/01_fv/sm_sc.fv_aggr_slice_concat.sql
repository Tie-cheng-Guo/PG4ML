...
--   (
--     array[[B'010', B'011', B'010', B'011']
--          ,[B'101', B'011', B'010', B'011']
--          ,[B'101', B'011', B'010', B'011']
--          ,[B'101', B'011', B'010', B'011']
--          ,[B'101', B'011', B'010', B'011']
--          ,[B'101', B'011', B'010', B'011']]
...
-- select sm_sc.fv_aggr_slice_concat
--   (
--     array[[[B'010', B'011', B'010', B'011', B'101', B'011', B'010', B'011']],[[B'010', B'011', B'010', B'011', B'101', B'011', B'010', B'011']]]
--   );
...
begin
  ...
  then
    ...
    -- --       array_agg
    -- --       (
    -- --         sm_sc.fv_aggr_slice_concat(i_array[a_cur_y : a_cur_y + i_cnt_per_grp[1] - 1][a_cur_x : a_cur_x + i_cnt_per_grp[2] - 1]) 
    -- --         order by a_cur_x
    -- --       ) as a_slice_x
...
--   sm_sc.fv_aggr_slice_concat
--   (
--     array[[B'010', B'011', B'010', B'011', B'0101', B'011']
--          ,[B'101', B'011', B'010', B'011', B'01000', B'011']
--          ,[B'101', B'011', B'010', B'011', B'01011', B'011']
--          ,[B'101', B'011', B'010', B'011', B'01000', B'011']
--          ,[B'101', B'011', B'010', B'011', B'0101', B'011']
--          ,[B'101', B'011', B'010', B'011', B'0101111', B'011']]
--     , array[2, 3]
--   )
