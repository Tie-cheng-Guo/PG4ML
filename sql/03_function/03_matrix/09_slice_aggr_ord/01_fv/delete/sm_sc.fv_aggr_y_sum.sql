...
-- --     (
-- --       select 
-- --         array[array_agg(sm_sc.fv_aggr_slice_sum_py(i_array[ : ][col_a_x : col_a_x]) order by col_a_x)]
...
-- --   (
-- --     select 
-- --       sm_sc.fa_mx_concat_y(sm_sc.fv_aggr_y_sum(i_array[a_cur : a_cur + i_cnt_per_grp - 1][ : ]) order by a_cur)
