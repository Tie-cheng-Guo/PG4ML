...
-- --     (
-- --       select 
-- --         array_agg(array[sm_sc.fv_aggr_slice_avg_py(i_array[col_a_y : col_a_y][ : ])] order by col_a_y)
...
-- --   (
-- --     select 
-- --       sm_sc.fa_mx_concat_x(sm_sc.fv_aggr_x_avg(i_array[ : ][a_cur : a_cur + i_cnt_per_grp - 1]) order by a_cur)
