...
create or replace function sm_sc.fv_aggr_slice_coalesce
(
  i_array          anyarray
)
returns anyelement
...
cost 100;
-- -- set search_path to sm_sc;
-- select sm_sc.fv_aggr_slice_coalesce
--   (
--     array[array[null,2,3,4,5,6]
--         , array[10,20,30,40,50,60]
--         , array[100,null,300,400,500,600]
--         , array[-1,-2,-3,-4,-5,-6]
--         , array[-10,-20,-30,-40,-50,-60]
...
-- select sm_sc.fv_aggr_slice_coalesce
--   (
--     array[null,null,3,4,5,6]::float[]
--   );

-- select sm_sc.fv_aggr_slice_coalesce
--   (
--     array[[[null,2,3,4,25,6],[-1,-2,-3,4,5,6]],[[1,null,3,-4,-5,-36],[1,12,3,14,5,6]]]::float[]
--   );

-- select sm_sc.fv_aggr_slice_coalesce
--   (
--     array[[[[null,null,3,4,25,6],[null,-2,-3,4,35,6]],[[null,2,3,-4,-5,-36],[null,12,3,14,25,6]]],[[[1,12,3,4,25,6],[-1,-42,-3,4,5,6]],[[1,2,13,-4,-5,-36],[1,12,3,14,5,6]]]]::float[]
--   );
...
begin
  ...
  then
    ...
    -- --       array_agg
    -- --       (
    -- --         sm_sc.fv_aggr_slice_coalesce(i_array[a_cur_y : a_cur_y + i_cnt_per_grp[1] - 1][a_cur_x : a_cur_x + i_cnt_per_grp[2] - 1]) 
    -- --         order by a_cur_x
    -- --       ) as a_slice_x
...
--   sm_sc.fv_aggr_slice_coalesce
--   (
--     array[[null,2,3,4,5,6]
--          ,[10,20,null,40,50,60]
--          ,[100,200,300,null,500,600]
--          ,[-1,null,-3,-4,-5,-6]
--          ,[-10,-20,null,null,-50,-60]
--          ,[-100,-200,null,-400,-500,-600]
--          ]::float[]
--     , array[2, 3]
--   )
