...
create or replace function sm_sc.fv_idx_1d_min
(
  i_arr           anyarray
)
  returns int
...
-- select sm_sc.fv_idx_1d_min(array[1.2, 2.3, 5.6, 52.1])
-- select sm_sc.fv_idx_1d_min(array[array[1.2, 2.3, 5.6, 52.1]])
-- select sm_sc.fv_idx_1d_min(array[array[1.2], array[2.3], array[5.6], array[52.1]])
