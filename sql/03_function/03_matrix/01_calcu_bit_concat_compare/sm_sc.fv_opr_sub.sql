...
begin
  ...
  then 
    return sm_sc.fv_opr_sub_py(i_left, i_right);
  else  
    v_len_depdt :=
      (
        select 
...
-- select sm_sc.fv_opr_sub(array[]::float[], 8.8::float)
-- select sm_sc.fv_opr_sub(array[]::float[], null)
-- select sm_sc.fv_opr_sub(array[1.2, 2.3]::float[], 8.8::float)
-- select sm_sc.fv_opr_sub(array[array[], array []]::float[], 8.8::float)
...
-- select sm_sc.fv_opr_sub(8.8::float, array[]::float[] )
-- select sm_sc.fv_opr_sub(null, array[]::float[])
-- select sm_sc.fv_opr_sub(8.8::float, array[1.2, 2.3]::float[] )
-- select sm_sc.fv_opr_sub(8.8::float, array[array[], array []]::float[])
...
begin
  if pg_typeof(i_right) = ('double precision[]' :: regtype)
  then 
    return sm_sc.fv_opr_sub_py(i_right);
