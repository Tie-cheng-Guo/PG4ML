...
--   sm_sc.fv_opr_concat
--   ( 
--     sm_sc.fv_new_rand(array[2, 3, 1, 5]) :: text[]
--   , sm_sc.fv_new_rand(array[   1, 4, 5]) :: text[]
--   )
-- select 
--   sm_sc.fv_opr_concat
--   ( 
  ...
  then
    ...
    loop
      ...
      loop
        ...
        loop
          i_left[v_y_cur][v_x_cur][v_x3_cur] = 
            concat(i_left[v_y_cur][v_x_cur][v_x3_cur], i_right)
          ;
        end loop;    
      end loop;
    end loop;
    ...
    loop
      ...
      loop
        ...
        loop
          ...
          loop
            i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 
              concat(i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur], i_right)
            ;
          end loop;
        end loop;    
      end loop;
  ...
  then
    ...
    loop
      ...
      loop
        ...
        loop
          i_right[v_y_cur][v_x_cur][v_x3_cur] = 
            concat(i_left, i_right[v_y_cur][v_x_cur][v_x3_cur])
          ;
        end loop;    
      end loop;
    end loop;
    ...
    loop
      ...
      loop
        ...
        loop
          ...
          loop
            i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 
            concat(i_left, i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur])
            ;
          end loop;
        end loop;    
      end loop;
