...
begin
  ...
  then 
    return sm_sc.fv_opr_log_py(i_left, i_right);
  else    
    v_len_depdt :=
      (
        select 
        ...
        loop
          ...
          loop
            i_left[v_y_cur][v_x_cur][v_x3_cur] = 
              log(i_left[v_y_cur][v_x_cur][v_x3_cur] :: decimal, i_right[v_y_cur][v_x_cur][v_x3_cur] :: decimal) 
            ;
          end loop;    
        end loop;
      end loop;
          ...
          loop
            ...
            loop
              i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 
                log(i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] :: decimal, i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] :: decimal)
              ;
            end loop;
          end loop;    
        end loop;
      ...
      loop
        ...
        loop
          i_left[v_y_cur][v_x_cur][v_x3_cur] = 
            log 
            (
              i_left[v_y_cur][v_x_cur][v_x3_cur] :: decimal
            , i_right :: decimal
            )
          ;
        end loop;    
        ...
        loop
          ...
          loop
            i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 
              log 
              (
                i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] :: decimal
              , i_right :: decimal
              )
            ;
          end loop;
...
-- select sm_sc.fv_opr_log(array[]::float[], 8.8::float)
-- select sm_sc.fv_opr_log(array[array[], array []]::float[], 8.8::float)
-- select 
--   sm_sc.fv_opr_log
--   (
--     array[[[1.1,2,3],[1.2,2.3,3.4]],[[0.5,0.7,0.8],[0.3,0.4,0.7]]]
      ...
      loop
        ...
        loop
          i_right[v_y_cur][v_x_cur][v_x3_cur] = 
            ...
            (
              i_left :: decimal
            , i_right[v_y_cur][v_x_cur][v_x3_cur] :: decimal
            )
          ;
        end loop;    
      end loop;
        ...
        loop
          ...
          loop
            i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 
              ...
              (
                i_left :: decimal
              , i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] :: decimal
              )
            ;
          end loop;
        end loop;    
