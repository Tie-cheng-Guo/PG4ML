...
-- select sm_sc.fv_opr_xor(array[false], array[array[true, false]]);
-- select sm_sc.fv_opr_xor(array[array[true]], array[true, false]);
...
-- select sm_sc.fv_opr_xor(array[array[B'101']], array[B'101', B'011']);
-- select sm_sc.fv_opr_xor(array[array[B'101']], array[array[B'101', B'011']]);
-- set session pg4ml._v_is_debug_check = '1';
-- set session pg4ml._v_is_debug_check = '0';
-- select 
--   sm_sc.fv_opr_xor
