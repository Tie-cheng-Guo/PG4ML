...
create or replace function sm_sc.fv_d_div_2
(
  i_indepdt_var float[] , 
...
declare 
  ...
  ;
begin
  v_ret           :=  -` (i_co_value /` (i_indepdt_var ^` 2.0 :: float));
  v_depdt_var_len := 
    (
      select 
...
-- select 
--   sm_sc.fv_d_div_2(array[2.8, 3.6], array[1.8, -4.6])
-- select 
--   sm_sc.fv_d_div_2(array[[2.8, 3.6], [2.4, -1.6]], array[[1.8, -4.6], [1.4, 3.6]])
-- select 
--   sm_sc.fv_d_div_2(array[[[2.8, 3.6], [2.4, -1.6]],[[1.8, -4.6], [1.4, 3.6]]], array[[[1.8, -4.6], [1.4, 3.6]],[[2.8, 3.6], [2.4, -1.6]]])
-- select 
--   sm_sc.fv_d_div_2(array[[[[1.8, -4.6], [1.4, 3.6]],[[2.8, 3.6], [2.4, -1.6]]],[[[2.8, 3.6], [2.4, -1.6]],[[1.8, -4.6], [1.4, 3.6]]]]
--                   , array[[[[2.8, 3.6], [2.4, -1.6]],[[1.8, -4.6], [1.4, 3.6]]],[[[1.8, -4.6], [1.4, 3.6]],[[2.8, 3.6], [2.4, -1.6]]]])
-- select 
--   sm_sc.fv_d_div_2(sm_sc.fv_new_rand(array[2, 1, 3]), sm_sc.fv_new_rand(array[3, 3]))
-- select 
--   sm_sc.fv_d_div_2(sm_sc.fv_new_rand(array[3, 3]), sm_sc.fv_new_rand(array[2, 1, 3]))
-- select 
--   sm_sc.fv_d_div_2(sm_sc.fv_new_rand(array[2, 1, 3, 5]), sm_sc.fv_new_rand(array[3, 3, 5]))
-- select 
--   sm_sc.fv_d_div_2(sm_sc.fv_new_rand(array[3, 3, 5]), sm_sc.fv_new_rand(array[2, 1, 3, 5]))
-- select 
--   sm_sc.fv_d_div_2(sm_sc.fv_new_rand(array[4, 2, 1, 3]), sm_sc.fv_new_rand(array[3, 3]))
-- select 
--   sm_sc.fv_d_div_2(sm_sc.fv_new_rand(array[3, 3]), sm_sc.fv_new_rand(array[4, 2, 1, 3]))