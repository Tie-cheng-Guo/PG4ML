...
create or replace function sm_sc.fv_d_div_1
(
  i_co_value           float[] 
...
-- select 
--   sm_sc.fv_d_div_1(array[2.4, -1.6])
-- select 
--   sm_sc.fv_d_div_1(array[[2.8, 3.6], [2.4, -1.6]])
-- select 
--   sm_sc.fv_d_div_1(array[[[2.8, 3.6], [2.4, -1.6]],[[2.8, 3.6], [2.4, -1.6]]])
-- select 
--   sm_sc.fv_d_div_1(array[[[[2.8, 3.6], [2.4, -1.6]],[[2.8, 3.6], [2.4, -1.6]]],[[[2.8, 3.6], [2.4, -1.6]],[[2.8, 3.6], [2.4, -1.6]]]])
-- select 
--   sm_sc.fv_d_div_1(sm_sc.fv_new_rand(array[2, 1, 3]), array[3, 3])
-- select 
--   sm_sc.fv_d_div_1(sm_sc.fv_new_rand(array[3, 3]), array[2, 1, 3])
-- select 
--   sm_sc.fv_d_div_1(sm_sc.fv_new_rand(array[2, 1, 3, 5]), array[3, 3, 5])
-- select 
--   sm_sc.fv_d_div_1(sm_sc.fv_new_rand(array[3, 3, 5]), array[2, 1, 3, 5])
-- select 
--   sm_sc.fv_d_div_1(sm_sc.fv_new_rand(array[4, 2, 1, 3]), array[3, 3])
-- select 
--   sm_sc.fv_d_div_1(sm_sc.fv_new_rand(array[3, 3]), array[4, 2, 1, 3])