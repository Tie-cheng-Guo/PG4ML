  ...
  then
    ...
    loop
      ...
      loop
        ...
        loop
          i_left[v_y_cur][v_x_cur][v_x3_cur] := greatest(i_left[v_y_cur][v_x_cur][v_x3_cur], i_right[v_y_cur][v_x_cur][v_x3_cur]);
        end loop;    
      end loop;
    end loop;
    return i_left;
    ...
    loop
      ...
      loop
        ...
        loop
          ...
          loop
            i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] := greatest(i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur], i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur]);
          end loop;
        end loop;    
      end loop;
    end loop;
