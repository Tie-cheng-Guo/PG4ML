...
-- select sm_sc.fv_opr_xnor(array[false], array[array[true, false]]);
-- select sm_sc.fv_opr_xnor(array[array[true]], array[true, false]);
...
declare -- here
  ...
  v_x4_cur      int  := 1  ;
begin
  -- null :: boolean[][] xnor null :: boolean[][]
  ...
  then
    ...
    loop
      ...
      loop
        ...
        loop
          i_left[v_y_cur][v_x_cur][v_x3_cur] = 
            (i_left[v_y_cur][v_x_cur][v_x3_cur] = i_right)
          ;
        end loop;    
      end loop;
    end loop;
    ...
    loop
      ...
      loop
        ...
        loop
          ...
          loop
            i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 
              (i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = i_right)
            ;
          end loop;
        end loop;    
      end loop;
      ...
      loop
        ...
        loop
          i_right[v_y_cur][v_x_cur][v_x3_cur] = 
            (i_left = i_right[v_y_cur][v_x_cur][v_x3_cur]) 
          ;
        end loop;    
      end loop;
    end loop;
        ...
        loop
          ...
          loop
            i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 
              (i_left = i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur]) 
            ;
          end loop;
        end loop;    
      end loop;
...
-- select sm_sc.fv_opr_xnor(array[array[B'101']], array[B'101', B'011']);
-- select sm_sc.fv_opr_xnor(array[array[B'101']], array[array[B'101', B'011']]);
-- set session pg4ml._v_is_debug_check = '1';
-- set session pg4ml._v_is_debug_check = '0';
-- select 
--   sm_sc.fv_opr_xnor
