      ...
      loop
        ...
        loop
          i_left[v_y_cur][v_x_cur][v_x3_cur] = 
            (i_left[v_y_cur][v_x_cur][v_x3_cur] and i_right[v_y_cur][v_x_cur][v_x3_cur]) 
          ;
        end loop;    
      end loop;
    end loop;
        ...
        loop
          ...
          loop
            i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 
              (i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] and i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur]) 
            ;
          end loop;
        end loop;    
      end loop;
...
declare -- here
  ...
  v_x4_cur      int  := 1  ;
begin
  -- null :: boolean[][] and boolean = null :: boolean[][]
      ...
      loop
        ...
        loop
          i_right[v_y_cur][v_x_cur][v_x3_cur] = 
            i_left 
            and i_right[v_y_cur][v_x_cur][v_x3_cur] 
          ;
        end loop;    
      end loop;
    end loop;
        ...
        loop
          ...
          loop
            i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 
              i_left
              and i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] 
            ;
          end loop;
        end loop;    
      end loop;
