...
begin
  ...
  then 
    return sm_sc.fv_opr_pow_py(i_left, i_right);
  else    
    v_len_depdt :=
      (
        select 
    ...
    loop
      ...
      loop
        ...
        loop
          i_left[v_y_cur][v_x_cur][v_x3_cur] = 
              case 
                when i_left[v_y_cur][v_x_cur][v_x3_cur] > 1.0 and i_right = '-inf' :: float
                  or i_left[v_y_cur][v_x_cur][v_x3_cur] < 1.0 and i_right = 'inf' :: float 
                  then 0.0
                else i_left[v_y_cur][v_x_cur][v_x3_cur] ^ i_right
              end
          ;
        end loop;    
      end loop;
      ...
      loop
        ...
        loop
          ...
          loop
            i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 
              case 
                when i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] > 1.0 and i_right = '-inf' :: float
                  or i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] < 1.0 and i_right = 'inf' :: float 
                  then 0.0
                else i_left[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] ^ i_right
              end
            ;
          end loop;
        end loop;    
...
-- select sm_sc.fv_opr_pow(array[]::float[], 8.8::float)
-- select sm_sc.fv_opr_pow(array[]::float[], null)
-- select sm_sc.fv_opr_pow(array[1.2, 2.3]::float[], 8.8::float)
-- select sm_sc.fv_opr_pow(array[array[], array []]::float[], 8.8::float)
      ...
      loop
        ...
        loop
          i_right[v_y_cur][v_x_cur][v_x3_cur] = 
            case 
              when i_left > 1.0 and i_right[v_y_cur][v_x_cur][v_x3_cur] = '-inf' :: float
                or i_left < 1.0 and i_right[v_y_cur][v_x_cur][v_x3_cur] = 'inf' :: float 
                then 0.0
              else i_left ^ i_right[v_y_cur][v_x_cur][v_x3_cur] 
            end
          ;
        end loop;    
      end loop;
        ...
        loop
          ...
          loop
            i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 
              case 
                when i_left > 1.0 and i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = '-inf' :: float
                  or i_left < 1.0 and i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] = 'inf' :: float 
                  then 0.0
                else i_left ^ i_right[v_y_cur][v_x_cur][v_x3_cur][v_x4_cur] 
              end
            ;
          end loop;
        end loop;    
...
-- select sm_sc.fv_opr_pow(8.8::float, array[]::float[] )
-- select sm_sc.fv_opr_pow(null, array[]::float[])
-- select sm_sc.fv_opr_pow(8.8::float, array[1.2, 2.3]::float[] )
-- select sm_sc.fv_opr_pow(8.8::float, array[array[], array []]::float[])
