...
begin
  ...
  then 
    return sm_sc.fv_opr_mul_py(i_left, i_right);
  else    
    v_len_depdt :=
      (
        select 
...
-- select sm_sc.fv_opr_mul(array[]::float[], 8.8::float)
-- select sm_sc.fv_opr_mul(array[]::float[], null)
-- select sm_sc.fv_opr_mul(array[1.2, 2.3]::float[], 8.8::float)
-- select sm_sc.fv_opr_mul(array[array[], array []]::float[], 8.8::float)
...
-- select sm_sc.fv_opr_mul(8.8::float, array[]::float[] )
-- select sm_sc.fv_opr_mul(null, array[]::float[])
-- select sm_sc.fv_opr_mul(8.8::float, array[1.2, 2.3]::float[] )
-- select sm_sc.fv_opr_mul(8.8::float, array[array[], array []]::float[])
