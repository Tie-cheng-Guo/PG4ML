...
begin
  ...
  then 
    return sm_sc.fv_opr_is_greater_py(i_left, i_right);
  else    
    v_len_depdt :=
      (
        select 
...
-- select sm_sc.fv_opr_is_greater(array[]::float[], 8.8::float)
-- select sm_sc.fv_opr_is_greater(array[array[], array []]::float[], 8.8::float)
-- select 
--   sm_sc.fv_opr_is_greater
--   (
--     array[[[1,2,3],[1.2,2.3,3.4]],[[0.5,0.7,0.8],[0.3,0.4,0.7]]]
...
-- select sm_sc.fv_opr_is_greater(8.8::float, array[]::float[] )
-- select sm_sc.fv_opr_is_greater(8.8::float, array[array[], array []]::float[])
-- select 
--   sm_sc.fv_opr_is_greater
--   (
--     2.2
