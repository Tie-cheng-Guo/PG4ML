...
create or replace function sm_sc.fv_standlize_x3_l1l2ln
(
  i_array     float[]   ,
  i_n         float
)
...
parallel safe
cost 100;
-- -- select sm_sc.fv_standlize_x3_l1l2ln(sm_sc.fv_new_rand(array[4]), 3) :: decimal[] ~=` 3
-- -- select sm_sc.fv_standlize_x3_l1l2ln(sm_sc.fv_new_rand(array[2, 3]), 3) :: decimal[] ~=` 3
-- select sm_sc.fv_standlize_x3_l1l2ln(sm_sc.fv_new_rand(array[2, 3, 5]), 3) :: decimal[] ~=` 3
-- select sm_sc.fv_standlize_x3_l1l2ln(sm_sc.fv_new_rand(array[2, 3, 5, 6]), 3) :: decimal[] ~=` 3
-- select sm_sc.fv_standlize_x3_l1l2ln(array[]::float[], 3)
-- select sm_sc.fv_standlize_x3_l1l2ln(array[[],  []]::float[], 3)