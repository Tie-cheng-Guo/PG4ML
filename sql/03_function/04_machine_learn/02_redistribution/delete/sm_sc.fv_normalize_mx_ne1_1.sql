...
declare -- here
  ...
  v_ptp       float   :=   v_max - v_min;
    -- coalesce(nullif(v_ptp, 0.0 :: float), 'NaN' :: float);       
...
parallel safe
cost 100;
-- select sm_sc.fv_normalize_mx_ne1_1(array[[12.3, 25.1], [2.56, 3.25]])
-- select sm_sc.fv_normalize_mx_ne1_1(array[[[12.3, 25.1], [2.56, 3.25]]])
-- select sm_sc.fv_normalize_mx_ne1_1(array[[[[12.3, 25.1], [2.56, 3.25]]]])
-- select sm_sc.fv_normalize_mx_ne1_1(array[12.3, 25.1, 28.33])
-- select sm_sc.fv_normalize_mx_ne1_1(array[]::float[])
-- select sm_sc.fv_normalize_mx_ne1_1(array[[],  []]::float[])