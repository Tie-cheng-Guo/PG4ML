...
begin
  ...
  then
    ...
    v_max_x3   := sm_sc.fv_aggr_slice_max(i_array, v_x3_lens);
    v_ptp_x3   := v_max_x3 -` v_min_x3;
    v_2_median_x3 := v_max_x3 +` v_min_x3;
    return (i_array -` sm_sc.fv_new(v_2_median_x3, v_x3_lens)) /` sm_sc.fv_new(v_ptp_x3 /` 2.0 :: float, v_x3_lens);
  else
