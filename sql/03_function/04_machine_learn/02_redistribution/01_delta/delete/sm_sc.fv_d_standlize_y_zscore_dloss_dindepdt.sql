...
begin
  ...
  if i_depdt is null
  then
    i_depdt := sm_sc.fv_standlize_y_zscore(i_indepdt);
  end if;
...
--   sm_sc.fv_d_standlize_y_zscore_dloss_dindepdt
--   (
--     sm_sc.fv_standlize_y_zscore(array[[12.3, 25.1, 8.2], [2.56, 3.33, -1.9], [3.25, 26.4, 6.6], [56.4, -2.65, -4.6], [3.25, 26.4, 6.6], [56.4, -2.65, -4.6]], 3),
