...
-- --   elsif array_length(i_dloss_ddepdt, 1) <> (v_y - i_window_len[1]) / i_stride[1] + 1
-- --     or array_length(i_dloss_ddepdt, 2) <> (v_x - i_window_len[2]) / i_stride[2] + 1
-- --   then
...
-- --               |**| sm_sc.fv_mx_ele_2d_2_1d(i_dloss_ddepdt) 
-- --             )
-- --             ,
-- --             i_window_len[2]
-- --           ) 
