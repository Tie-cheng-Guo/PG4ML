...
-- , anyelement
-- );
create or replace function sm_sc.fv_d_conv_de_log_dloss_dindepdt_1
(
  i_window                anyarray           ,
  -- i_window_len            int[]             ,
...
cost 100;
-- -- set search_path to sm_sc;
-- select sm_sc.fv_d_conv_de_log_dloss_dindepdt_1
-- (
...
--   sm_sc.fv_conv_de_log                                         -- i_depdt_var             anyarray 
--   (
