...
-- -- , anyelement
-- );
create or replace function sm_sc.fv_d_conv_log_dloss_dindepdt_1
(
...
begin
  ...
  then
    ...
    elsif v_depdt_var_len is not null and v_depdt_var_len <> v_dloss_ddepdt_len_2d
    then 
      ...
      (
        select 
          ...
          *` 
          ...
          sm_sc.fv_d_log_1
          (
            i_background[(a_cur_heigh - 1) * i_stride[1] + 1 : (a_cur_heigh - 1) * i_stride[1] + v_window_len[1]]
...
--   sm_sc.fv_conv_log                                         -- i_depdt_var             anyarray 
--   (
...
--   array[3, 3]                   ,                           -- v_window_len            int[2]                 -- array[1, 2, 3, 3]
--   null :: float[]               ,                           -- i_depdt_var             anyarray  
--   -- array[6, 9]                   ,                           -- i_depdt_var_len         int[2]    
--   array              
--   [[
