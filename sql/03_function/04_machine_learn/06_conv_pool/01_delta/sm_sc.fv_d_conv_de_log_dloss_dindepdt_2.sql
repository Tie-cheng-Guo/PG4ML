...
-- , anyelement
-- );
create or replace function sm_sc.fv_d_conv_de_log_dloss_dindepdt_2
(
  i_window                anyarray           ,
  -- i_window_len            int[]             ,
...
--   array[[1.3,4,7],[2,5,8],[3,6,9]] :: float[],                -- i_window                anyarray  
--   -- array[3, 3]                   ,                           -- v_window_len            int[2]    
--   array[[[1.2,2,3,4,5],[3,4,5,6,7],[2,4,6,8,5],[7,5,3,4,8]],[[1.2,2,3,4,5],[3,4,5,6,7],[2,4,6,8,5],[7,5,3,4,8]]] :: float[],   -- i_background            anyarray  
--   -- array[4, 5]                   ,                           -- v_background_len        int[2]    
--   -- sm_sc.fv_conv_de_log                                         -- i_depdt_var             anyarray 
--   -- (
--   --   array[[1.3,4,7],[2,5,8],[3,6,9]] :: float[],
