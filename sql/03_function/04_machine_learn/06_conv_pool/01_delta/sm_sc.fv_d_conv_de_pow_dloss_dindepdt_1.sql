...
-- , anyelement
-- );
create or replace function sm_sc.fv_d_conv_de_pow_dloss_dindepdt_1
(
  i_window                anyarray           ,
  -- i_window_len            int[2]             ,
...
begin
  ...
  then
    ...
    -- then 
    --   v_depdt_var_len := array[array_length(i_depdt_var, 1), array_length(i_depdt_var, 2)];
    -- end if;
...
-- (
--   array[[1.2,4,7],[2,5,8],[3,6,9]] :: float[],                -- i_window                anyarray  
...
-- select sm_sc.fv_d_conv_de_pow_dloss_dindepdt_1
-- (
--   array[[1.2,4,7],[2,5,8],[3,6,9]] :: float[],                        -- i_window                anyarray    -- array[[[1.2,4,7],[2,5,8],[3,6,9]],[[1.2,4,7],[2,5,8],[3,6,9]]]
--   -- array[3, 3]                   ,                           -- v_window_len            int[2]    
--   array              
--   [
--     [[1.2, 2, 3, 4, 5, 6, 7, 8, 9]                
...
--   -- array[6, 9]                   ,                           -- v_background_len_ex        int[2]    
--   null :: float[]               ,                           -- i_depdt_var             anyarray  
--   array[6, 9]                   ,                           -- i_depdt_var_len         int[2]        -- array[2, 6, 9]
--   array              
--   [
--     [[1.2, 2, 3, 4, 5, 6, 7, 8, 9]                
--     ,[11, 12, 13, 14, 15, 16, 17, 18, 19]                
