...
create or replace function sm_sc.fv_conv_add
(
  ...
  then 
    ...
    (
      ...
      (
        select 
          col_a_y,
          sm_sc.fa_mx_concat_x(i_background[col_a_y : col_a_y + v_window_len_heigh - 1][col_a_x : col_a_x + v_window_len_width - 1] +` i_window order by col_a_x) as a_ret_y
