...
create or replace function sm_sc.fv_pool_median
(
  i_array              anyarray                                             ,
  ...
  then
    ...
    (
      ...
      (
        select 
          col_a_y,
          array_agg(sm_sc.fv_aggr_slice_median(i_array[col_a_y : col_a_y + i_window_len[1] - 1][col_a_x : col_a_x + i_window_len[2] - 1]) order by col_a_x) as ret_y
