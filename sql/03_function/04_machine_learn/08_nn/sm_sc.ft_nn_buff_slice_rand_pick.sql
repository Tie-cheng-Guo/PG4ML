...
create or replace function sm_sc.ft_nn_buff_slice_rand_pick
(
  i_work_no            bigint             ,
...
(
  o_ord_no                    int
, o_rand_pick_indepdt_01      float[] 
, o_rand_pick_indepdt_02      float[] 
, o_rand_pick_indepdt_03      float[] 
, o_rand_pick_indepdt_04      float[] 
)
as
$$
declare 
...
begin
  ...
  return query
    ...
    , i_indepdt_01 as o_rand_pick_indepdt_01
    , i_indepdt_02 as o_rand_pick_indepdt_02
    , i_indepdt_03 as o_rand_pick_indepdt_03
    , i_indepdt_04 as o_rand_pick_indepdt_04
