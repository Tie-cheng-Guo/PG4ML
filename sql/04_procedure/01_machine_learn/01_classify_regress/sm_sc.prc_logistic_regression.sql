...
(
  ...
  -- i_indepdt_01                                float[][]                       ,      -- [v_len_x1_y1][v_len_x2_w1]                                                         -- 对象的已知参数矩阵
  -- i_depdt_01                                float[][]                       ,      -- [v_len_x1_y1][v_len_w2_y2]                                                         -- 分类结果，要求类似onehot编码形式，0.0 <=` v_i_depdt_01 <=` 1.0
...
$$
declare -- here
-- -- 数学原理：已知矩阵 v_i_indepdt_01, v_i_depdt_01, 且 sigmoid(v_i_indepdt_01 |**| v_ret_w) == (v_i_depdt_01), 求 v_ret_w
  ...
  v_len_x2_w1                 int               := array_length(v_i_indepdt_01, 2) + 1;
  v_x                         float[][]:= sm_sc.fv_new(1.0 :: float, array[v_len_x1_y1, 1]) |||| v_i_indepdt_01;
  ...
  v_i_depdt_01_rand_samp             float[];           -- [v_len_x1_y1][v_len_w2_y2]
...
raise notice 'step 00, v_cur_loss_delta: %;', v_cur_loss_delta :: decimal[] ~=` 4;
...
raise notice 'step 1 begin: v_i_depdt_01_rand_samp: %', v_i_depdt_01_rand_samp :: decimal[] ~=` 4;
...
raise notice 'step 1 end: v_i_depdt_01_rand_samp: %', v_i_depdt_01_rand_samp :: decimal[] ~=` 4;
        ...
        select 
          ...
          (
            ...
            (
              ...
              -` v_i_depdt_01_rand_samp[a_cur_x1_y1 : a_cur_x1_y1][a_cur_w2_y2 : a_cur_w2_y2]
            ))
