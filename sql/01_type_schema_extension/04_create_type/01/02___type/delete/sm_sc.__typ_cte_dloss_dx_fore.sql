...
create type sm_sc.__typ_cte_dloss_dindepdt_fore as
(
  -- -- m_learn_cnt                       int                 ,
  m_node_no                        bigint                 ,
  m_node_fn_type                   varchar(64)         ,
  m_a_dloss_dindepdt_fore_1st            float[]    ,
  m_a_dloss_dindepdt_fore_2nd            float[]    ,
...
--     array[12.3, 15.3]                             ,
--     array[array[12.3, 15.3], array[12.3, 15.3]]   
--   ) :: sm_sc.__typ_cte_dloss_dindepdt_fore