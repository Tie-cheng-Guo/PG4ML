...
begin
  delete from sm_sc.tb_nn_node where work_no = 2022030501;
  delete from sm_sc.tb_nn_path where work_no = 2022030501;
  commit;
  ...
  select 
    ...
    'input'                  as node_type              ,          -- 按照分类标记排序，0，1，2，3，4，。。。9，并记录下每个分类的数据集结束位置下标 n0, n1, n2,... n9
    'buff_slice_rand_pick'   as node_fn_type
  -- -- union all
  -- -- select 
  -- --   2022030501               as work_no                ,
  ...
  select 
    ...
    null                     as node_type              ,
    'conv_2d'                as node_fn_type          -- 窗口：5*5
  ...
  select 
    ...
    null                     as node_type              ,
    'pool_max'               as node_fn_type          -- 窗口：2*2
  from generate_series(1, 6) tb_a_ord(a_ord)         -- 
  union all
  select 
    2022030501               as work_no                ,
  ...
  where node_fn_type = 'leaky_relu'
    and work_no = 2022030501
  ;
  
  update sm_sc.tb_nn_node tb_node
  set node_fn_asso_value = array[28, 5, 5, 1, 1, 2, 2, 2, 2, 0]   -- -- , 28 * 28
  where node_fn_type = 'conv_2d'
    and node_no between 101010001 and 101010006
    and work_no = 2022030501
  ;
  commit;
  update sm_sc.tb_nn_node tb_node
  ...
  where node_fn_type = 'conv_2d'
    and node_no between 103010001 and 103010060
    and work_no = 2022030501
  ;
  commit;
  ...
  where node_fn_type = 'pool_max'
    and node_no between 102010001 and 102010006
    and work_no = 2022030501
  ;
  commit;
  update sm_sc.tb_nn_node tb_node
  ...
  where node_fn_type = 'pool_max'
    and node_no between 105010001 and 105010016
    and work_no = 2022030501
  ;
  commit;
