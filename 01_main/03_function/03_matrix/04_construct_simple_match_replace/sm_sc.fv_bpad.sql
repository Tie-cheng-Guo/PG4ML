...
-- drop function if exists sm_sc.fv_bpad(anyarray, int, anyarray);
create or replace function sm_sc.fv_bpad
(
  i_array            anyarray      ,
  i_len              int           ,
...
begin
  ...
  return sm_sc.fv_bpad(i_array, i_len, v_fill_values);
