...
create or replace function sm_sc.fv_aggr_x_mode
(
  i_array          anyarray
)
returns anyarray
...
begin
  ...
  then
    ...
    (
      select 
        array_agg(array[sm_sc.fv_aggr_slice_mode(i_array[col_a_y : col_a_y][ : ])] order by col_a_y)
...
cost 100;
-- -- set search_path to sm_sc;
-- select sm_sc.fv_aggr_x_mode
--   (
--     array[array[1,2,3,4,5,6]
--         , array[-10,-20,-30,40,50,60]
--         , array[100,300,300,-400,500,600]
--         , array[-1,-2,-3,-2,-5,-6]
--         , array[-10,-20,-10,-40,50,-60]
--         , array[-400,-200,-300,-400,-500,600]
--          ]::float[]
--   );
