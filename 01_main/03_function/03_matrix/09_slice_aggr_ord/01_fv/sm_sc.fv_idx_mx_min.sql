...
create or replace function sm_sc.fv_idx_mx_min
(
  i_arr           anyarray
)
  returns int[2]
    ...
    loop 
      ...
      loop 
        ...
        then
          ...
          v_cur_min_pos := array[v_cur_y, v_cur_x];
        end if;
        v_cur_x := v_cur_x + 1;
      end loop;
      v_cur_y := v_cur_y + 1;
...
-- select sm_sc.fv_idx_mx_min(array[array[1.2, 2.3, 5.6, 52.1]])
-- select sm_sc.fv_idx_mx_min(array[array[1.2], array[2.3], array[5.6], array[52.1]])
