...
create or replace function sm_sc.fv_opr_is_less
(
  i_left     anyarray    ,
  i_right    anyarray
)
...
begin
  ...
  then 
    return sm_sc.fv_opr_is_less(i_left[1], i_right);
  -- less([], [.])
  elsif array_ndims(i_right) = 1 and array_length(i_right, 1) = 1
  then 
    return sm_sc.fv_opr_is_less(i_left, i_right[1]);

  -- less([[.]], [])
  elsif array_length(i_left, 2) = 1 and array_length(i_left, 1) = 1
  then 
    return sm_sc.fv_opr_is_less(i_left[1][1], i_right);
  -- less([], [[.]])
  elsif array_length(i_right, 2) = 1 and array_length(i_right, 1) = 1
  then 
    return sm_sc.fv_opr_is_less(i_left, i_right[1][1]);
...
--     array[12.5, 19.1, 5.6]
--   );
-- select sm_sc.fv_opr_is_less(array[1], array[1,2,3]);
-- select sm_sc.fv_opr_is_less(array[1], array[array[1,2,3]]);
-- select sm_sc.fv_opr_is_less(array[array[1]], array[1,2,3]);
-- select sm_sc.fv_opr_is_less(array[array[1]], array[array[1,2,3]]);
...
parallel safe
cost 100;
-- select sm_sc.fv_opr_is_less(array[array[12.3, 25.1], array[2.56, 3.25]], 8.8)
-- select sm_sc.fv_opr_is_less(array[12.3, 25.1, 2.56, 3.25], 8.8)
-- select sm_sc.fv_opr_is_less(array[]::float[], 8.8)
-- select sm_sc.fv_opr_is_less(array[array[], array []]::float[], 8.8)
...
parallel safe
cost 100;
-- select sm_sc.fv_opr_is_less(8.8, array[array[12.3, 25.1], array[2.56, 3.25]])
-- select sm_sc.fv_opr_is_less(8.8, array[12.3, 25.1, 2.56, 3.25])
-- select sm_sc.fv_opr_is_less(8.8, array[]::float[] )
-- select sm_sc.fv_opr_is_less(8.8, array[array[], array []]::float[])
