...
--   );
-- -- select sm_sc.fv_opr_add    -- 设计不支持一维二维混合运算
-- --   (
-- --     array[32.5, -9.1],
-- --     array[array[-12.3, 12.3], array[-45.6, 45.6]]
-- --   );
...
--     array[2.1, 3.2]::float[]
--   );
-- select sm_sc.fv_opr_add(array[1], array[1,2,3]);
-- select sm_sc.fv_opr_add(array[1], array[array[1,2,3]]);
-- select sm_sc.fv_opr_add(array[array[1]], array[1,2,3]);
-- select sm_sc.fv_opr_add(array[array[1]], array[array[1,2,3]]);
...
parallel safe
cost 100;
-- select sm_sc.fv_opr_add(array[array[12.3, 25.1], array[2.56, 3.25]], 8.8)
-- select sm_sc.fv_opr_add(array[]::float[], 8.8)
-- select sm_sc.fv_opr_add(array[]::float[], null)
-- select sm_sc.fv_opr_add(array[1.2, 2.3]::float[], 8.8)
-- select sm_sc.fv_opr_add(array[array[], array []]::float[], 8.8)
-- select sm_sc.fv_opr_add(array[1.2, 2.3]::float[], null::float)
...
parallel safe
cost 100;
-- select sm_sc.fv_opr_add(8.8, array[array[12.3, 25.1], array[2.56, 3.25]])
-- select sm_sc.fv_opr_add(8.8, array[]::float[] )
-- select sm_sc.fv_opr_add(null, array[]::float[])
-- select sm_sc.fv_opr_add(8.8, array[1.2, 2.3]::float[] )
-- select sm_sc.fv_opr_add(8.8, array[array[], array []]::float[])
-- select sm_sc.fv_opr_add(null::float, array[1.2, 2.3]::float[] )