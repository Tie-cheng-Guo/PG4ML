...
begin
  ...
  then 
    return sm_sc.fv_opr_is_equal(i_left[1], i_right);
  -- greater([], [.])
  elsif array_ndims(i_right) = 1 and array_length(i_right, 1) = 1
  then 
    return sm_sc.fv_opr_is_equal(i_left, i_right[1]);

  -- greater([[.]], [])
  elsif array_length(i_left, 2) = 1 and array_length(i_left, 1) = 1
  then 
    return sm_sc.fv_opr_is_equal(i_left[1][1], i_right);
  -- greater([], [[.]])
  elsif array_length(i_right, 2) = 1 and array_length(i_right, 1) = 1
  then 
    return sm_sc.fv_opr_is_equal(i_left, i_right[1][1]);
...
-- select sm_sc.fv_opr_is_equal(array[]::float[], 8.8)
-- select sm_sc.fv_opr_is_equal(array[array[], array []]::float[], 8.8)
...
-- select sm_sc.fv_opr_is_equal(8.8, array[]::float[] )
-- select sm_sc.fv_opr_is_equal(8.8, array[array[], array []]::float[])
