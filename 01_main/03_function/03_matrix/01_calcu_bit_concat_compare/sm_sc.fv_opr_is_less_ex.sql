...
create or replace function sm_sc.fv_opr_is_less_ex
(
  i_left     anyarray    ,
  i_right    anyarray
)
...
begin
  ...
  then 
    return sm_sc.fv_opr_is_less_ex(i_left[1], i_right);
  -- less([], [.])
  elsif array_ndims(i_right) = 1 and array_length(i_right, 1) = 1
  then 
    return sm_sc.fv_opr_is_less_ex(i_left, i_right[1]);

  -- less([[.]], [])
  elsif array_length(i_left, 2) = 1 and array_length(i_left, 1) = 1
  then 
    return sm_sc.fv_opr_is_less_ex(i_left[1][1], i_right);
  -- less([], [[.]])
  elsif array_length(i_right, 2) = 1 and array_length(i_right, 1) = 1
  then 
    return sm_sc.fv_opr_is_less_ex(i_left, i_right[1][1]);
...
cost 100;
-- -- set search_path to sm_sc;
-- select sm_sc.fv_opr_is_less_ex
--   (
...
--     array[12.5, 19.1, 5.6]
--   );
-- select sm_sc.fv_opr_is_less_ex(array[1], array[1,2,3]);
-- select sm_sc.fv_opr_is_less_ex(array[1], array[array[1,2,3]]);
-- select sm_sc.fv_opr_is_less_ex(array[array[1]], array[1,2,3]);
-- select sm_sc.fv_opr_is_less_ex(array[array[1]], array[array[1,2,3]]);
...
begin
  -- less(null :: float[][], float) = null :: float[][]
...
parallel safe
cost 100;
-- select sm_sc.fv_opr_is_less_ex(array[array[12.3, 25.1], array[2.56, 3.25]], 8.8)
-- select sm_sc.fv_opr_is_less_ex(array[12.3, 25.1, 2.56, 3.25], 8.8)
-- select sm_sc.fv_opr_is_less_ex(array[]::float[], 8.8)
-- select sm_sc.fv_opr_is_less_ex(array[array[], array []]::float[], 8.8)
...
parallel safe
cost 100;
-- select sm_sc.fv_opr_is_less_ex(8.8, array[array[12.3, 25.1], array[2.56, 3.25]])
-- select sm_sc.fv_opr_is_less_ex(8.8, array[12.3, 25.1, 2.56, 3.25])
-- select sm_sc.fv_opr_is_less_ex(8.8, array[]::float[] )
-- select sm_sc.fv_opr_is_less_ex(8.8, array[array[], array []]::float[])
