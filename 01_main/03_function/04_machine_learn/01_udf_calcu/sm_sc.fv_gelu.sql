-- gelu: i_y = 0.5 * i_x * (1.0 :: float+ tanh(power(2.0 / pi(), 0.5 :: float) * (i_x + (0.044715 * power(i_x, 3)))))
...
-- declare
begin
  return 0.5 * i_x * (1.0 :: float+ tanh(0.7978845608028654 * (i_x + (0.044715 * power(i_x, 3)))));
end
$$
