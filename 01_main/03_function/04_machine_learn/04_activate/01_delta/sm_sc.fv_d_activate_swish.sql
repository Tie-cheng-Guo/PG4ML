-- drop function if exists sm_sc.fv_d_activate_swish(float[]);
...
cost 100;
-- select sm_sc.fv_d_activate_swish(array[array[1.0 :: float, -2.0], array[3.0, 4.0]])
-- select sm_sc.fv_d_activate_swish(array[1.5, -2.5, 3.5])
-- select sm_sc.fv_d_activate_swish(array[]::float[])
-- select sm_sc.fv_d_activate_swish(array[array[], array []]::float[])