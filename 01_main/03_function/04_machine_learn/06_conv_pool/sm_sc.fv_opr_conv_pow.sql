...
-- drop function if exists sm_sc.fv_opr_conv_pow(anyarray, anyarray);
create or replace function sm_sc.fv_opr_conv_pow
(
...
--         , [100.0 :: float,20.0 :: float,30.0 :: float,40.0 :: float,50.0 :: float,60.0 :: float,70.0, 8.0, 9.0]
