...
-- drop function if exists sm_sc.fv_opr_conv_log(anyarray, anyarray);
create or replace function sm_sc.fv_opr_conv_log
(
...
--         , [10.0 :: float,20.0 :: float,30.0 :: float,40.0 :: float,50.0 :: float,60.0 :: float,70.0, 8.0, 9.0]
--          ]
--    , array[[1.5 :: float, 2.0, 3.0], [1.5, 2.0, 3.0], [3.0, 2.0, 1.0]]
--   );
