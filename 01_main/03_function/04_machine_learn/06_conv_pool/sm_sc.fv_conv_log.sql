  ...
  then 
    ...
    (
      ...
      (
        select 
          col_a_y,
          sm_sc.fa_mx_concat_x(i_background[col_a_y : col_a_y + v_window_len_y - 1][col_a_x : col_a_x + v_window_len_x - 1] ^!` i_window order by col_a_x) as ret_y
...
--         , array[10.0 :: float,20.0 :: float,30.0 :: float,40.0 :: float,50.0 :: float,60.0 :: float,70.0]
--          ]
--    , array[[1.0 :: float, 2.0, 3.0], [1.5, 3.0, 2.0], [3.0, 2.0, 1.5]]
--    , array[2, 2]
--   );
