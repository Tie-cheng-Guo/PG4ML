...
begin
  ...
  , array[5, 5]      as node_fn_asso_value      -- array[1, 25]
  ...
  , null                     as node_type          
  , '05_conv_2d'                as node_fn_type          -- 窗口：5*5
  , array[null, null, null, 1, 1, 2, 2, 2, 2, 0]                        as node_fn_asso_value    -- array[28, 5, 5, 1, 1, 2, 2, 2, 2, 0]
  ...
  , array[1, 28, 28]      as node_fn_asso_value  -- array[1, 28 * 28] 
  ...
  , null                     as node_type       
  , '05_pool_max'               as node_fn_type          -- 窗口：2*2
  , array[null, 2, 2, 2, 2, 0, 0, 0, 0, null]                        as node_fn_asso_value  -- array[28, 2, 2, 2, 2, 0, 0, 0, 0, null, 28 * 28]
  from generate_series(1, 6) tb_a_ord(a_ord)         -- 
  union all
  select 
    -000000002               as work_no          
  ...
  , null                     as node_type       
  , '05_conv_2d'                as node_fn_type          -- 窗口：5*5
  , array[null, null, null, 1, 1, 0, 0, 0, 0, null]                        as node_fn_asso_value    -- array[14, 5, 5, 1, 1, 0, 0, 0, 0, null]
  ...
  , null                     as node_type       
  , '03_zscore'               as node_fn_type    -- zscore_x  
  , array[1, 10, 10]      as node_fn_asso_value         -- array[1, 100]
  from generate_series(1, 16) tb_a_ord(a_ord)         
  union all
  select 
    -000000002               as work_no      
  ...
  , null                     as node_type
  , '05_pool_max'               as node_fn_type          -- 窗口：2*2
  , array[null, 2, 2, 2, 2, 0, 0, 0, 0, null]                        as node_fn_asso_value    -- array[10, 2, 2, 2, 2, 0, 0, 0, 0, null, 10 * 10]
  from generate_series(1, 16) tb_a_ord(a_ord)       
  union all
  select 
    -000000002               as work_no      
  ...
  select 
    -000000002               as work_no      
  , -105030001                as node_no 
  , null                     as node_type
  , '04_mx_ele_flatten_2dims'           as node_fn_type    
  , array[2, 3, 3] :: decimal[]      as node_fn_asso_value
  union all
  select 
    -000000002               as work_no      
  ...
  , null                     as node_type
  , '03_zscore'               as node_fn_type    -- zscore_x   
  , array[1, 1, 64]      as node_fn_asso_value     -- array[1, 64]
  union all
  select 
    -000000002               as work_no      
  ...
  , array[1, 1, 10]      as node_fn_asso_value
  ;
  commit;
  ...
  -- lenet-5 卷积层第一大层 60 个输出稀疏连接第二大层 16 个输入: 
  ...
  select 
    -000000002          as work_no             ,
    -105030001           as fore_node_no     ,
    1                   as path_ord_no         , -- mx_ele_flatten_2dims
  ...
  -- -- where node_fn_type = '05_pool_max'
